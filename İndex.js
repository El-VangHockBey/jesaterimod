...
client.login("OTA2NDU0ODYxNzQ5NTYzNDEy.YYY34A.vYk114OJakq888semREEiZBnpw0").then(x => console.log(`[BOT] ${client.user.username} Olarak giriş yaptı`)).catch(err => console.log(`[BOT] Giriş yapamadı sebep: ${err}`))
