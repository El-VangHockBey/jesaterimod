...
module.exports = {
    ...
    run: async (client, message, args) => {
        ...
        let embed = new MessageEmbed().setAuthor(message.member.displayName, message.author.avatarURL({dynamic: true})).setFooter("Developed By El_VangHockBey").setColor("RANDOM").setTimestamp();
